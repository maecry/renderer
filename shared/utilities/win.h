...
#pragma region win_definitions
#define WIN_GET_IMP(MODULE, NAME) reinterpret_cast<decltype(&NAME)>(WIN::GetImportAddress(MODULE, #NAME))
...
#pragma region winapi_nt
 ...
 // @todo: support both x86 and x64 (currently only x64)
 // @credits: https://www.vergiliusproject.com/kernels/x64/Windows%2011
...
#pragma region winapi_functions
...
namespace WIN
{
	...
	[[nodiscard]] bool GetSectionInfo( const void* hModuleBase, const char* szSectionName, UCHAR** ppSectionStart, ULONGLONG* pnSectionSize );
}
